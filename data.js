...
const SUBJECTS = [
  ...
  { id:13, num:'13', name:'Sintaxis y Semántica de los Lenguajes (1°Cuat.)', hours:'4 hs/sem', level:2, correlCursada:[5,6], correlAprobada:[] },
  { id:14, num:'14', name:'Paradigmas de Programación (2°Cuat.)', hours:'4 hs/sem', level:2, correlCursada:[5,6], correlAprobada:[] },
  ...
  // ── TERCER NIVEL ──
  { id:17, num:'17', name:'Probabilidad y Estadística',     hours:'3 hs/sem', level:3, correlCursada:[1,2], correlAprobada:[] },
  { id:18, num:'18', name:'Economía (2°Cuat.)',               hours:'3 hs/sem', level:3, correlCursada:[], correlAprobada:[1,2] },
  { id:19, num:'19', name:'Base de Datos (1°Cuat.)',         hours:'4 hs/sem', level:3, correlCursada:[13,16], correlAprobada:[5,6] },
  { id:20, num:'20', name:'Desarrollo de Software (2°Cuat.|Anual)',  hours:'4 hs/sem', level:3, correlCursada:[14,16], correlAprobada:[5,6] },
  { id:21, num:'21', name:'Comunicación de Datos (1°Cuat.)',  hours:'4 hs/sem', level:3, correlCursada:[], correlAprobada:[3,7] },
  ...
  // ── CUARTO NIVEL ──
  { id:24, num:'24', name:'Legislación (2°Cuat.)',           hours:'2 hs/sem', level:4, correlCursada:[11], correlAprobada:[] },
  { id:25, num:'25', name:'Ing. de Software (1°Cuat.)',       hours:'3 hs/sem', level:4, correlCursada:[19,20,23], correlAprobada:[13,14] },
  { id:26, num:'26', name:'Redes de Datos (2°Cuat.)',         hours:'4 hs/sem', level:4, correlCursada:[15,21], correlAprobada:[] },
  { id:27, num:'27', name:'Investigación Operativa (1°Cuat.)', hours:'4 hs/sem', level:4, correlCursada:[17,22], correlAprobada:[] },
  { id:28, num:'28', name:'Simulación (1°Cuat.)',             hours:'3 hs/sem', level:4, correlCursada:[17], correlAprobada:[9] },
  { id:29, num:'29', name:'Tecnologías para la Automatización (2°Cuat.)', hours:'3 hs/sem', level:4, correlCursada:[10,22], correlAprobada:[9] },
  { id:30, num:'30', name:'Administración de Sistemas de Información | Recursos (Integradora)', hours:'6 hs/sem', level:4, correlCursada:[18,23], correlAprobada:[16] },
  ...
  // ── QUINTO NIVEL ──
  { id:31, num:'31', name:'Inteligencia Artificial (1°Cuat.)', hours:'3 hs/sem', level:5, correlCursada:[28], correlAprobada:[17,22] },
  { id:32, num:'32', name:'Ciencia de Datos (1°Cuat.)',       hours:'3 hs/sem', level:5, correlCursada:[28], correlAprobada:[17,19] },
  { id:33, num:'33', name:'Sistemas de Gestión',     hours:'4 hs/sem', level:5, correlCursada:[18,27], correlAprobada:[23] },
  { id:34, num:'34', name:'Gestión Gerencial (1°Cuat.)',      hours:'3 hs/sem', level:5, correlCursada:[24,30], correlAprobada:[18] },
  { id:35, num:'35', name:'Seguridad en los Sistemas de Información (2°Cuat.)', hours:'3 hs/sem', level:5, correlCursada:[26,30], correlAprobada:[20,21] },
...
const ELECTIVAS = {
  3: [
    { id:'E2', num:'E2', name:'Sistemas de Tiempo Real (2°Cuat.)',  hours:'6 hs/sem (3 hs anuales)', annualHours: 3, correlCursada:[15], correlAprobada:[7] },
    ...
    { id:'E4', num:'E4', name:'Sistemas de Transmisiones Inalámbricos (2°Cuat.)', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[9], correlAprobada:[7] },
    { id:'E5', num:'E5', name:'Responsabilidad Social e Institucional (1°Cuat.)', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[8,16], correlAprobada:[] },
    { id:'E6', num:'E6', name:'Comunicación Profesional',            hours:'6 hs/sem (3 hs anuales)', annualHours: 3, correlCursada:[11], correlAprobada:[8] },
  ],
  4: [
    { id:'E14', num:'E14', name:'Desarrollo de Aplicaciones Móviles (1°Cuat.)',   hours:'6 hs/sem (3 hs anuales)', annualHours: 3, correlCursada:[14,23], correlAprobada:[6] },
    ...
    { id:'E8', num:'E8', name:'Desarrollo de Software Cloud (2°Cuat.)', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[15,20,23], correlAprobada:[13,14] },
  ...
  5: [
    { id:'E16', num:'E16', name:'Gestión Operativa y Seguridad en Redes (2°Cuat.)', hours:'8 hs/sem (4 hs anuales)', annualHours: 4, correlCursada:[30], correlAprobada:[26] },
    { id:'E15', num:'E15', name:'Ingeniería en Calidad',              hours:'6 hs/sem (3 hs anuales)', annualHours: 3, correlCursada:[30], correlAprobada:[23] },
    { id:'E17', num:'E17', name:'Protocolos y Seguridad en Redes Inalámbricas (1°Cuat.)', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[21,26], correlAprobada:[9,10] },
